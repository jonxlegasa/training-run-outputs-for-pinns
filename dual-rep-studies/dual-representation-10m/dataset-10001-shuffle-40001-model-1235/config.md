...
- Batch size: **16384**
- Epochs: **100**
- Global updates per epoch: **611**
- Global total optimizer updates: **61100**
...
- Dense MLPs: power series `2→64→64→64→21` (**9,877 parameters**); eigenvalue `2→64→64→64→4` (**8,772 parameters**)
- Dataset seed: **10001**
- Shuffle seed: **40001**
- Model initialization seed: **1235**
- Final power-series filename: `model-dense-mlp-p009877.checkpoint`
- Final eigenvalue filename: `model-dense-mlp-p008772.checkpoint`
